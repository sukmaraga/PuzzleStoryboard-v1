...
----------------------------------------------------------------------------------
local blank2, blank1, blank3,blank4,blank5, xt2, xt, xu, xr, xl , xe, correct, pindah, turtle
local soal = 0
...
function scene:createScene( event )
	...
	turtle = display.newImageRect("hewan/turtle.png",190,115)
	turtle.x = _FX*.8; turtle.y=_FY/3
	...
	xt2 = display.newImageRect	 ("huruf/t.png",55,55); 		xt2.x = h5 xt2.y=_Y
	blank4 = display.newImageRect("huruf/blank.png",55,55) ;blank4.x = h6 blank4.y=_Y
	blank5 = display.newImageRect("huruf/blank.png",55,55); blank5.x = h7 blank5.y=_Y
	...
	xu = display.newImageRect("huruf/u.png",55,55) xu.x = math.random(10,_FX-10) xu.y=math.random(10,_FY-10) xu.rotation=math.random(-40,40)
	...
	screenGroup:insert( xu )
	screenGroup:insert( xe )
	screenGroup:insert( xt2 )
...
function scene:enterScene( event )
	storyboard.purgeScene( "12whale" )
	
	local function pindah(e)
		storyboard.gotoScene( "14shark", "slideDown", 500  )
	end
	...
	function xt:touch( event )
		if event.phase == "began" and klik == 0 then
			...
			self.markX = self.x    -- store x loturtleion of object
			self.markY = self.y    -- store y loturtleion of object
...
function scene:exutScene( event )
	local group = self.view
	
	-----------------------------------------------------------------------------
	xt:removeEventListener( "touch", xt )
	xu:removeEventListener( "touch", xu )
...
-- "createScene" event is dispatched if scene's view does not exust
scene:addEventListener( "createScene", scene )

-- "enterScene" event is dispatched whenever scene transition has finished
scene:addEventListener( "enterScene", scene )

-- "exutScene" event is dispatched before nexl scene's transition begins
scene:addEventListener( "exutScene", scene )
