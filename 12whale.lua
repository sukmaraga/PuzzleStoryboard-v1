...
----------------------------------------------------------------------------------
local blank2, blank1, blank3,blank4, xw, xh, xa, xl , xe, correct, pindah, whale
local soal = 0
...
function scene:createScene( event )
	...
	whale = display.newImageRect("hewan/whale.png",188,127)
	whale.x = _FX*.8; whale.y=_FY/3
	...
	xw = display.newImageRect("huruf/w.png",55,55) xw.x = math.random(10,_FX-10) xw.y=math.random(10,_FY-10) xw.rotation=math.random(-40,40)
...
function scene:enterScene( event )
	storyboard.purgeScene( "11lion" )
	
	local function pindah(e)
		storyboard.gotoScene( "13turtle", "slideDown", 500  )
	end
	...
	function xw:touch( event )
		if event.phase == "began" and klik == 0 then
		
			self.markX = self.x    -- store x lowhaleion of object
			self.markY = self.y    -- store y lowhaleion of object
...
function scene:exhtScene( event )
	...
	-----------------------------------------------------------------------------
	xw:removeEventListener( "touch", xw )
...
-- "exhtScene" event is dispatched before nexl scene's transition begins
