...
----------------------------------------------------------------------------------
local blank2, blank1, blank3,blank4, blank5, xs, xh, xa, xr , xk, correct, pindah, shark
local soal = 0
...
function scene:createScene( event )
	...
	shark = display.newImageRect("hewan/shark.png",188,140)
	shark.x = _FX*.8; shark.y=_FY/3
...
function scene:enterScene( event )
	storyboard.purgeScene( "13turtle" )
	
	local function pindah(e)
		storyboard.gotoScene( "15horse", "slideDown", 500  )
	end
	...
	function xs:touch( event )
		if event.phase == "began" and klik == 0 then
			...
			self.markX = self.x    -- store x losharkion of object
			self.markY = self.y    -- store y losharkion of object
...
-- "exhtScene" event is dispatched before nexr scene's transition begins
